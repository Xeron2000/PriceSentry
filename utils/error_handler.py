                ...
                try:
                    ...
                    if attempt == max_retries:
                        self._log_error(
                            ...
                            error_message=f"Retry attempts exhausted for {func.__name__}",
                    ...
                    self._log_error(
                        ...
                        error_message=f"Retry attempt {attempt + 1}/{max_retries} for {func.__name__}",
                        error_category=ErrorCategory.NETWORK,
                ...
                try:
                    ...
                    if attempt == max_retries:
                        self._log_error(
                            ...
                            error_message=f"Async retry attempts exhausted for {func.__name__}",
                            error_category=ErrorCategory.NETWORK,
                            severity=ErrorSeverity.ERROR,
                            context={"function": func.__name__, "attempts": attempt + 1},
                            original_error=e
                    ...
                    self._log_error(
                        ...
                        error_message=f"Async retry attempt {attempt + 1}/{max_retries} for {func.__name__}",
                        error_category=ErrorCategory.NETWORK,
                        severity=ErrorSeverity.WARNING,
                        context={
                            "function": func.__name__,
