...
class TestTelegramNotification:
    ...
    def test_send_telegram_message_success(self):
        ...
        with patch('notifications.telegram.requests.post') as mock_post:
            ...
            assert "https://api.telegram.org/bottest_token/sendMessage" in call_args[1]['url']
    ...
    def test_send_telegram_message_network_error(self):
        ...
        with patch('notifications.telegram.requests.post') as mock_post:
            with patch('builtins.print') as mock_print:
                ...
                assert result is False
                mock_print.assert_called_with("Error while sending Telegram message: Network error")
    ...
    def test_send_telegram_photo_success(self):
        ...
        with patch('notifications.telegram.requests.post') as mock_post:
            ...
            # Verify the call parameters
            call_args = mock_post.call_args
            assert "https://api.telegram.org/bottest_token/sendPhoto" in call_args[1]['url']
            assert call_args[1]['data']['chat_id'] == "test_chat_id"
    ...
    def test_send_telegram_photo_api_error(self):
        ...
        with patch('notifications.telegram.requests.post') as mock_post:
            with patch('builtins.print') as mock_print:
                ...
                assert result is False
                mock_print.assert_called_with("Failed to send photo: Internal Server Error")
    ...
    def test_send_telegram_photo_network_error(self):
        ...
        with patch('notifications.telegram.requests.post') as mock_post:
            with patch('builtins.print') as mock_print:
                ...
                assert result is False
                mock_print.assert_called_with("Error while sending Telegram photo: Network error")
