...
class TestMatchSymbols:
    ...
    def test_match_symbols_success(self):
        ...
        with patch('builtins.open', mock_open(read_data=json.dumps(supported_markets))), \
    ...
    def test_match_symbols_exchange_not_supported(self):
        ...
        with patch('builtins.open', mock_open(read_data=json.dumps(supported_markets))), \
            ...
            assert result == []
            mock_print.assert_called_with("Exchange unsupported_exchange not supported.")
    ...
    def test_match_symbols_whitespace_in_symbols(self):
        ...
        symbols = ['BTC ', ' ETH', ' XRP ']  # Symbols with whitespace
        exchange = 'binance'
