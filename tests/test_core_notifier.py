...
class TestNotifier:
    ...
    def test_init_basic(self, sample_config):
        ...
        assert notifier.notification_channels == sample_config.get(
    ...
    def test_init_with_full_config(self):
        ...
        full_config = {
            ...
            "dingding": {"enabled": True, "webhook": "test_webhook"},
        }
        ...
        assert notifier.dingding_config == {"enabled": True, "webhook": "test_webhook"}
